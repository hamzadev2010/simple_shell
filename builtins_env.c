...
/**
 * builtin_env - display environment where the shell runs
 * @data: structure for the program's data
 * Return: zero if it's true, or antoher number if its declared in args
 */
