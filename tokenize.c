...
/**
 * tokenize - Separate a string using a specified delimiter.
 *
 * function takes pointer to program data and separate a string into
 * different parts using a designated delimiter.
 *
